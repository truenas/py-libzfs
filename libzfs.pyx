...
class Error(enum.IntEnum):
    ...
    CHECKPOINT_EXISTS = libzfs.EZFS_CHECKPOINT_EXISTS
    DISCARDING_CHECKPOINT = libzfs.EZFS_DISCARDING_CHECKPOINT
    NO_CHECKPOINT = libzfs.EZFS_NO_CHECKPOINT
    DEVRM_IN_PROGRESS = libzfs.EZFS_DEVRM_IN_PROGRESS
    VDEV_TOO_BIG = libzfs.EZFS_VDEV_TOO_BIG
    IOC_NOTSUPPORTED = libzfs.EZFS_IOC_NOTSUPPORTED
    TOOMANY = libzfs.EZFS_TOOMANY
    INITIALIZING = libzfs.EZFS_INITIALIZING
    NO_INITIALIZE = libzfs.EZFS_NO_INITIALIZE
    WRONG_PARENT = libzfs.EZFS_WRONG_PARENT
    TRIMMING = libzfs.EZFS_TRIMMING
    NO_TRIM = libzfs.EZFS_NO_TRIM
    TRIM_NOTSUP = libzfs.EZFS_TRIM_NOTSUP
